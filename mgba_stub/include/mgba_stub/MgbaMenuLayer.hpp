...
public:
    ...
    void setCheatPagePlaceholder(bool enabled) { m_cheatPagePlaceholder = enabled; }
    void setDisplayPagePlaceholder(bool enabled) { m_displayPagePlaceholder = enabled; }
...
private:
    ...
    bool m_cheatPagePlaceholder = false;
    bool m_displayPagePlaceholder = false;
