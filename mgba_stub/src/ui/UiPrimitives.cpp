...
const HighlightGradientTexture& getHighlightGradientTexture()
{
    ...
    if (!openedPath)
    {
        appendStubLog("GBAStationMgbaStub: highlight gradient image not found");
        return gHighlightGradient;
    }
        ...
        gHighlightGradient.height > 4096)
    {
        ...
        appendStubLog("GBAStationMgbaStub: highlight gradient decode failed path=%s reason=%s",
                      openedPath,
    ...
    appendStubLog("GBAStationMgbaStub: highlight gradient loaded path=%s size=%dx%d tex=%u",
                  openedPath,
                  gHighlightGradient.width,
                  gHighlightGradient.height,
