...
class CoreMelonDS : public IEmulatorCore {
public:
    CoreMelonDS() = default;
    ~CoreMelonDS();
    ...
    void SetPointerState(bool pressed, int16_t x, int16_t y) override {
        m_core.setPointerState(pressed, x, y);
    }
    void SetAnalogState(int16_t rightX, int16_t rightY) override {
        m_core.setAnalogState(rightX, rightY);
    }
