...
namespace beiklive
{
    ...
    void AboutPage::buildUI()
    {
        ...
        header->setTitle("GBAStation");
        header->setPath("version 0.0.1");
        ...
        bottomBox->setWidth(brls::View::AUTO);
        ...
        contentBox->addView(midBox);
        contentBox->addView(bottomBox);
    }
} // namespace beiklive
