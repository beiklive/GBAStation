...
if (TARGET fmt::fmt)
    message(STATUS "Using fmt: host target fmt::fmt")
    get_target_property(fmt_INCLUDE_DIRS fmt::fmt INTERFACE_INCLUDE_DIRECTORIES)
    if (fmt_INCLUDE_DIRS)
        list(GET fmt_INCLUDE_DIRS 0 fmt_INCLUDE_DIR)
        get_filename_component(fmt_SOURCE_DIR "${fmt_INCLUDE_DIR}/.." ABSOLUTE)
    endif()
else()
...
set(CMAKE_MODULE_PATH "${FETCHCONTENT_BASE_DIR}/melonds-src/cmake" "${CMAKE_CURRENT_LIST_DIR}" "${FETCHCONTENT_BASE_DIR}/embed-binaries-src/cmake" "${CMAKE_MODULE_PATH}")
set(BUILD_STATIC ON)
...
set(MELONDSDS_FETCHCONTENT_DEPS melonDS libretro-common embed-binaries glm zlib libslirp pntr yamc span-lite date)
if (TARGET fmt::fmt)
    FetchContent_MakeAvailable(${MELONDSDS_FETCHCONTENT_DEPS})
else()
    FetchContent_MakeAvailable(${MELONDSDS_FETCHCONTENT_DEPS} fmt)
endif()
